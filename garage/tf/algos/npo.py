...
class NPO(BatchPolopt):
    def __init__(self,
                 ...
                 stop_entropy_gradients=True,
                 **kwargs):
        self.name = name
        self._name_scope = tf.name_scope(self.name)
        self._use_softplus_entropy = use_softplus_entropy
        self._log_estimate_entropy = log_estimate_entropy
        ...
        with tf.name_scope("policy_entropy"):
            if self.policy.recurrent:
                policy_dist_info_flat = self.policy.dist_info_sym(
                    ...
                    i.policy_state_info_vars,
                    name="policy_dist_info")
                policy_log_likeli_flat = self.policy.distribution.log_likelihood_sym(  # noqa: E501
                    i.action_var,
                    policy_dist_info_flat,
            ...
            if self._log_estimate_entropy:
                policy_entropy_flat = policy_log_likeli_flat
            else:
